...
{
    public partial class InlockContextr : DbContext
    {
        public InlockContextr()
        {
        }

        public InlockContextr(DbContextOptions<InlockContextr> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DEV9\\SQLEXPRESS; initial Catalog=Inlock_Games_Tarde; user Id=sa; pwd=sa@132;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Estudios>(entity =>
            {
                ...
                entity.HasIndex(e => e.NomeEstudio)
                    .HasName("UQ__Estudios__112A5690CE2E75ED")
                    .IsUnique();
            ...
            modelBuilder.Entity<TiposUsuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__TiposUsu__7B406B56B71DEF07")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D10534C4316EA8")
                    .IsUnique();
