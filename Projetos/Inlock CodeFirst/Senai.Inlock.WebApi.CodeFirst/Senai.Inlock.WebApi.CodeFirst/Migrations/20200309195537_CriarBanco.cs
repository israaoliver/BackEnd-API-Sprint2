    ...
    public partial class CriarBanco : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2012, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), " Bla bla bla bla bla bla bla bla blu", 1, "Diablo III", 99.00m },
                    { 2, new DateTime(2018, 10, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Blu ble bla bli blu blu blu bla ble blob bluab", 2, "Red Dead Redemption II", 120.00m }
                });
