...
namespace Senai.Inlock.WebApi.CodeFirst.Migrations
{
    ...
    [Migration("20200309195537_CriarBanco")]
            ...
            modelBuilder.Entity("Senai.Inlock.WebApi.CodeFirst.Domains.Estudios", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { IdEstudio = 2, NomeEstudio = "RockStar" },
            ...
            modelBuilder.Entity("Senai.Inlock.WebApi.CodeFirst.Domains.Jogos", b =>
                {
                    ...
                    b.HasData(
                        new { IdJogo = 1, DataLancamento = new DateTime(2012, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = " Bla bla bla bla bla bla bla bla blu", IdEstudio = 1, NomeJogo = "Diablo III", Valor = 99.00m },
                        new { IdJogo = 2, DataLancamento = new DateTime(2018, 10, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "Blu ble bla bli blu blu blu bla ble blob bluab", IdEstudio = 2, NomeJogo = "Red Dead Redemption II", Valor = 120.00m }
                    );
                });
            ...
            modelBuilder.Entity("Senai.Inlock.WebApi.CodeFirst.Domains.TiposUsuario", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { IdTipoUsuario = 2, Titulo = "Commum" }
                    );
                });
            ...
            modelBuilder.Entity("Senai.Inlock.WebApi.CodeFirst.Domains.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new { IdUsuario = 1, Email = "admin@admin.com", IdTipoUsuario = 1, Senha = "adm" },
